// seed.js — Seeds MongoDB with initial data if collections are empty
const bcrypt = require('bcryptjs');
const { v4: uuidv4 } = require('uuid');
const { User, Employee, Attendance, Leave, Payroll, Announcement, Job } = require('./models');
  ...
  try {
    ...
    if (empCount === 0) {
      await Employee.insertMany([
        { id:'RN-1001', name:'Badri Shiva', email:'shivabadri19@gmail.com', role:'Web Developer', department:'IT', salary:25000, joinDate:'2026-01-15', status:'Active', phone:'+91-9876543210', address:'Hyderabad, Telangana' },
        { id:'RN-1002', name:'Upender', email:'upender@risenext.com', role:'Director', department:'IT', salary:75000, joinDate:'2025-06-01', status:'Active', phone:'+91-9876543211', address:'Hyderabad, Telangana' },
        { id:'RN-1003', name:'Vinay', email:'vinay@risenext.com', role:'Director', department:'IT', salary:75000, joinDate:'2025-06-01', status:'Active', phone:'+91-9876543212', address:'Hyderabad, Telangana' },
        { id:'RN-1004', name:'Purushottam', email:'purushottam@risenext.com', role:'Tele Caller', department:'AR', salary:12000, joinDate:'2026-02-01', status:'Active', phone:'+91-9876543213', address:'Hyderabad, Telangana' },
        { id:'RN-1005', name:'Navya Bairu', email:'navyabairu@risenext.com', role:'Tele Caller', department:'AR', salary:12000, joinDate:'2026-02-01', status:'Active', phone:'+91-9876543214', address:'Hyderabad, Telangana' },
        { id:'RN-1006', name:'Sruthi', email:'sruthi@risenext.com', role:'Tele Caller', department:'AR', salary:12000, joinDate:'2026-02-01', status:'Active', phone:'+91-9876543215', address:'Hyderabad, Telangana' }
      ]);
    ...
    // ── PAYROLL ──
    const payCount = await Payroll.countDocuments();
    if (payCount === 0) {
    ...
    if (annCount === 0) {
      await Announcement.insertMany([
        { id:uuidv4(), title:'Q2 Appraisal Cycle — Submissions Due Today', body:'All managers must submit performance scores by EOD.', author:'HR Team', date:'2026-04-20', category:'HR' },
        { id:uuidv4(), title:'Tax Declaration Deadline — 30 April 2026', body:'All employees please submit investment declarations by April 30.', author:'Finance', date:'2026-04-14', category:'Finance' },
        { id:uuidv4(), title:'Welcome to Rise Next!', body:'We are excited to have our growing team onboard!', author:'HR Team', date:'2026-04-10', category:'General' }
      ]);
